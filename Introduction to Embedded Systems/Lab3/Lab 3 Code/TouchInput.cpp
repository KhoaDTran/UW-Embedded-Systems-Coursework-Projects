...
void touchInputTask(void* iData) {
    ...
    *****************/
    ...
    if (*data->page == ALARM_PAGE) {
        alarmInput(ts, p, *data->hvilStatus, data->hvilAcknowledged, *data->overcurrentStatus, data->ocAcknowledged,
                   *data->hvoorStatus, data->hvoorAcknowledged);
    }
    ...
    bool alarmsToAcknowledge = *data->hvilStatus == ANA || *data->overcurrentStatus == ANA || *data->hvoorStatus == ANA;
